...
#autostart
 ...
 350 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:PAPER 7:BORDER 7:INK 0:RUN AT %s:ERASE
 390 STOP
 ...
 440 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:PAPER 7:BORDER 7:INK 0:RUN AT %s:ERASE
 ...
 490 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:PAPER 7:BORDER 7:INK 0:RUN AT %s:ERASE
 ...
 630 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:PAPER 7:BORDER 7:INK 0:RUN AT %s:ERASE
 ...
 820 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:PAPER 7:BORDER 7:INK 0:RUN AT %s:ERASE
