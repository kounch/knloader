...
1000 ; Mode 3DOS (128K)
1010 DIM o$(1,LEN a$):LET o$(1)=a$:SAVE "m:kl99.tmp"DATA o$()
1020 GO SUB %5400:GO SUB %5500:CLEAR
...
1600 ; Mode TAP (Next)
1610 GO SUB %5400:.$ tapein a$:RUN AT %s:CLEAR
1620 DPOKE %$5c76,0:LOAD "t:":POKE 33792,0:CLEAR USR 33793
1630 REM DPOKE %$5c76,0:LOAD "t:":POKE 33792,1:CLEAR USR 33793:;LOAD "" CODE
1690 STOP

1700 ; Mode PI Audio (Next)
1710 GO SUB %5400:GO SUB %5600:RUN AT %s:CLEAR
1720 DPOKE %$5c76,0:LOAD "t:":POKE 33792,0:CLEAR USR 33793
1730 REM DPOKE %$5c76,0:LOAD "t:"POKE 33792,1:CLEAR USR 33793:;LOAD "" CODE
1790 STOP
