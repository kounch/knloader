...
#autostart
 ...
 600 IF mode=24 THEN GO TO 2500:;TZX LOAD "" CODE (128K)
 610 PRINT "ERROR: Unknown Mode":PAUSE 0:STOP
...
1430 REM LET m4=0:GO SUB 5500:SPECTRUM:POKE 32768,1:LET x=USR 32769:;LOAD "" CODE
1490 STOP
