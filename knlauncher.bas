...
1000 ; Mode 3DOS (128K)
1010 GO SUB 5400:GO SUB 5500:LOAD a$
1090 STOP
...
1310 GO SUB 5300:GO SUB 5400:GO SUB 5500
1320 MOVE "A:"OUT :MOVE "A:" IN a$:DIM o$(1):LET o$(1)=d$:SAVE "m:kl99.tmp"DATA o$()
1330 CLEAR :CD "A:":DIM o$(1):LOAD "m:kl99.tmp"DATA o$():LET a$=o$(1)
...
1540 GO SUB 5600:GO SUB 5500:CLEAR :DIM o(1):LOAD "m:kl99.tmp"DATA o():LET z=o(1)
1550 SPECTRUM :POKE 32768,z:LET x=USR 32769
1560 POKE 33792,z:CLEAR USR 33793
1590 STOP

1600 ; Mode TAP (Next)
1610 GO SUB 5400:.$ tapein a$:CLOSE # 4:OPEN # 4,a$
1620 LET a$=INKEY$ #4+INKEY$ #4+INKEY$ #4:LET %z=CODE INKEY$ #4
1630 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:DIM o(1):LET o(1)=%z:SAVE "m:kl99.tmp"DATA o()
1640 CLEAR :DIM o(1):LOAD "m:kl99.tmp"DATA o():LET z=o(1)
1650 RUN AT %s:DPOKE %$5c76,0:LOAD "t:":POKE 33792,z:CLEAR USR 33793
1690 STOP

1700 ; Mode PI Audio (Next)
1710 GO SUB 5400:CLOSE # 4:OPEN # 4,a$
1720 LET a$=INKEY$ #4+INKEY$ #4+INKEY$ #4:LET %z=CODE INKEY$ #4
1730 FOR %a=0 TO 15:CLOSE # %a:NEXT %a:DIM o(1):LET o(1)=%z:SAVE "m:kl99.tmp"DATA o()
1740 GO SUB 5600:CLEAR :DIM o(1):LOAD "m:kl99.tmp"DATA o():LET z=o(1)
1750 RUN AT %s:CLEAR :DPOKE %$5c76,0:LOAD "t:":POKE 33792,b:CLEAR USR 33793
1790 STOP
