...
#autostart
 ...
 200 ; Load Options
 210 LET maxpath=64
 220 LOAD "m:klo.tmp"DATA o()
 230 LOAD "m:kls.tmp"DATA o$()
...
1310 GO SUB %5300:DIM o$(1,maxpath):LET o$(1)=d$:SAVE "m:kl99.tmp" DATA o$()
1315 GO SUB %5400:GO SUB %5500
1320 MOVE "A:"OUT:MOVE "A:" IN a$
1330 CLEAR:CD "A:":LOAD "m:kl99.tmp"DATA o$():LET a$=o$(1):GO SUB %5400
...
1450 GO SUB %5500:CLEAR:LOAD "m:kl99.tmp"DATA o():LET z=o(1)
...
1640 CLEAR:LOAD "m:kl99.tmp"DATA o():LET z=o(1)
...
1740 GO SUB %5600:CLEAR:LOAD "m:kl99.tmp"DATA o():LET z=o(1)
